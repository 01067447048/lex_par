...
def pppplugins(parent_plugin):
    ...
    for plugin in parent_plugin.child_plugin_instances or []:
        ...
        if plugin.child_plugin_instances:
            found_plugins.extend(pppplugins(plugin))
...
class BRender:
    ...
    def gppp(self, placeholder, page=None):
...
class CRenders(BRender):
    ...
    def render_placeholder(self, placeholder, context, language=None, page=None,
        ...
        if editable:
            data = self.zxcvadsfqwer(placeholder, page=page)
    ...
    def zxcvadsfqwer(self, placeholder, page=None):
    ...
    def rppp(self, slot, context, inherit,
    ...
    def rspasdf(self, static_placeholder, context, nodelist=None):
    ...
    def render_plugin(self, instance, context, placeholder=None, editable=False):
        ...
        context = CCContext(context, instance, placeholder)
...
class SRender(BRender):
    ...
    def get_plugins_to_render(self, *args, **kwargs):
        ...
        for plugin in plugins:
            ...
            for plugin in pppplugins(plugin):
                yield plugin
    ...
    def render_placeholder(self, placeholder, language, page=None):
        ...
        placeholder_structure_is = self.placeholder_edit_template.format(
            ...
            plugin_menu_js=self.gppp(placeholder, page=page),
            placeholder_js=placeholder_toolbar_js,
        )
        return mark_safe(placeholder_structure_is)

    def rppp(self, page, placeholder, language=None):
        return self.render_placeholder(placeholder, language=language, page=page)

    def rspasdf(self, static_placeholder, language=None):
        user = self.request.user
...
class Lender(CRenders):
    ...
    def zxcvadsfqwer(self, placeholder, page=None):
        context = super().zxcvadsfqwer(placeholder, page)
        context['plugin_menu_js'] = self.gppp(placeholder, page=page)
        return context


class CCContext(Context):
    """
